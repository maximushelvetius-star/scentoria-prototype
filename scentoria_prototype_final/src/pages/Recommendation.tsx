...
import { translateNotesString, translateDescription } from "../utils/translation";
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3 text-xs">
              ...
              <div className="text-left flex-grow">
                ...
                <span className="font-extrabold text-stone-800 text-[11px]">{translateNotesString(primary.notes.head)}</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 text-xs">
              ...
              <div className="text-left flex-grow">
                ...
                <span className="font-extrabold text-stone-800 text-[11px]">{translateNotesString(primary.notes.heart)}</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 text-xs">
              ...
              <div className="text-left flex-grow">
                ...
                <span className="font-extrabold text-stone-800 text-[11px]">{translateNotesString(primary.notes.base)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-1">
          ...
          <AnimatePresence>
            {showFullDetails && (
              ...
              >
                <p>{translateDescription(primary.description)}</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
