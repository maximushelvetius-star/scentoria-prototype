...
import { getAllFragrances } from "../utils/recommendation";
...
export const Home: React.FC<HomeProps> = ({
  ...
  const fragCount = getAllFragrances().length;
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          >
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[9px] font-medium text-stone-400">{fragCount} Düfte</p>
            </div>
          </button>
